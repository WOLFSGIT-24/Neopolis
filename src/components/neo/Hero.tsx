...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Background Architectural Render with Reduced, Subtle Overlays */}
      <div className="absolute inset-0 z-0 opacity-85">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#FAF7F2] via-[#FAF7F2]/25 to-[#FAF7F2]/40" />
        <div className="absolute inset-0 bg-radial from-transparent via-transparent to-[#FAF7F2]/30" />
      </div>
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 w-full my-auto text-center flex flex-col items-center">
        {/* Subtle Tagline */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/90 border border-[#A85D45]/35 backdrop-blur-md mb-6 sm:mb-8 animate-fadeIn shadow-sm">
        ...
        <div className="max-w-4xl space-y-3 sm:space-y-4">
          <p className="text-sm sm:text-base md:text-lg uppercase tracking-[0.35em] text-[#A85D45] font-semibold drop-shadow-xs">
            An Address Above All
          </p>
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-serif font-light tracking-tight text-[#10141E] leading-[0.95] drop-shadow-sm">
            Neo Towers
          </h1>
          <p className="text-lg sm:text-2xl md:text-3xl font-serif italic text-[#A85D45] font-normal max-w-2xl mx-auto pt-2 drop-shadow-xs">
        ...
        <div className="mt-10 sm:mt-12 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full max-w-xl justify-center">
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-3.5 rounded-full text-xs font-semibold uppercase tracking-[0.18em] text-[#10141E] border border-[#A85D45]/40 hover:border-[#A85D45] hover:bg-[#A85D45]/10 bg-white/95 backdrop-blur-md transition-all flex items-center justify-center gap-2 whitespace-nowrap shadow-sm"
          >
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 w-full mt-12">
        {/* Info Strip */}
        <div className="rounded-2xl p-4 sm:p-6 mb-8 max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center divide-x-0 sm:divide-x divide-[#A85D45]/15 bg-white/95 border border-[#A85D45]/20 shadow-lg backdrop-blur-md">
          {stats.map((stat, idx) => (
