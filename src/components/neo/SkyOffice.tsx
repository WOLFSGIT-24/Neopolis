...
import { Briefcase, Users, Video, Wifi, Monitor, CheckCircle2 } from 'lucide-react'
...
export default function SkyOffice() {
  ...
  return (
    <section id="sky-office" className="relative w-full py-28 sm:py-36 bg-[#10131A] text-neo-ivory overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end mb-16">
          <div className="lg:col-span-6 space-y-3">
            ...
            <h2 className="text-4xl sm:text-6xl md:text-7xl font-serif font-light text-white leading-[1.05]">
              SKY OFFICE <br />
              <span className="italic text-neo-peach font-normal">Work above the ordinary.</span>
            </h2>
          </div>

          <div className="lg:col-span-6 lg:pl-8 lg:border-l border-white/10 space-y-4">
            ...
            <div className="flex items-center gap-3 text-xs uppercase tracking-wider text-[#C98D78] font-mono">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden border border-[#C98D78]/30 shadow-2xl bg-[#18243A] group">
              <Image
              ...
              <div className="absolute bottom-5 left-5 right-5 p-3 rounded-lg bg-black/60 backdrop-blur-md border border-white/10 flex items-center justify-between">
                <span className="text-xs font-serif text-white">{renders[activeImage].title}</span>
                <span className="text-[10px] uppercase font-mono tracking-wider text-[#C98D78]">{renders[activeImage].tag}</span>
              </div>
            </div>
              ...
              {renders.map((r, idx) => (
                <button
                  ...
                  className={`relative aspect-[16/9] rounded-xl overflow-hidden border transition-all ${
                    activeImage === idx
                      ? 'border-[#C98D78] ring-2 ring-[#C98D78]/30'
            ...
            <div className="space-y-3">
              {features.map((feat, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-4 rounded-xl bg-[#141822]/80 border border-white/5 hover:border-[#C98D78]/40 transition-all flex items-start gap-4"
                  >
                    <div className="w-9 h-9 rounded-xl bg-[#C98D78]/15 flex items-center justify-center text-[#C98D78] shrink-0 mt-0.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neo-muted leading-relaxed mt-0.5">
                        {feat.desc}
                      </p>
                    </div>
                  </div>
