    ...
    <>
      ...
      >
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 flex items-center justify-between">
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden lg:flex items-center gap-7 xl:gap-9 text-[13px] uppercase tracking-[0.18em] font-light text-neo-ivory/90">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="relative py-1 hover:text-[#C98D78] transition-colors duration-300 group"
              >
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="hidden xl:flex items-center gap-1.5 px-4 py-2 rounded-full text-[11px] uppercase tracking-[0.2em] font-medium text-neo-peach border border-[#C98D78]/30 hover:border-[#C98D78] hover:bg-[#C98D78]/10 transition-all"
            >
            ...
            <button
              ...
              className="relative px-5 sm:px-6 py-2 sm:py-2.5 rounded-full text-[12px] uppercase tracking-[0.2em] font-medium text-[#10131A] bg-gradient-to-r from-[#E8C5B8] via-[#C98D78] to-[#A86D58] hover:opacity-95 hover:shadow-lg hover:shadow-[#C98D78]/25 active:scale-95 transition-all duration-300"
            >
              Enquire Now
            </button>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-[#10131A]/98 backdrop-blur-2xl flex flex-col justify-between pt-24 pb-8 px-8 lg:hidden animate-fadeIn">
          <div className="flex flex-col gap-5 pt-4">
            ...
            {navLinks.map((link) => (
              <a
                ...
                className="text-2xl font-serif text-white hover:text-[#C98D78] transition-colors py-1 border-b border-white/5"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="space-y-3 pt-6">
            ...
            <div className="text-center pt-2 text-[11px] text-neo-muted">
